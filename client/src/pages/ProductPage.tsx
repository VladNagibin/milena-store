  ...
  return (
    <div className="product-page">
      ...
      <div className="top-panel">
        {product.pics ? (
          <Pictures id={id} pics={product.pics} />
        ) : (
          <div className="pics">
        ...
        <div className="specs">
          <div className="specs-values">
            ...
            {product.properties.map((prop) => {
              return (
                <div className="spec" key={prop.id}>
                  {prop.key}:{prop.value}
                </div>
              );
            })}
            ...
            <div style={{ display: 'flex' }}>
              {product.colors.map((color) => (
                <div
                  ...
                  className={`${
                    chosenColor == color.value ? 'chosen-color' : ''
                  }`}
                ></div>
              ))}
            </div>
          ...
          <div className="bottom">
            <div className="price">
              <div className="value">{product.price}р</div>
      ...
      <div className="description">
        ...
        <div className="banner">
          Товары представлены в ассортименте, выбор цветов или моделей не
          предоставляется. На фотографиях могут быть представлены не все
          варианты.
        </div>
      </div>
